...
```{r}
easy_ham_URL = "http://spamassassin.apache.org/old/publiccorpus/20021010_easy_ham.tar.bz2"
...
```{r class.source = "fold-show", warning=FALSE, echo=TRUE}
...
`list.files` is also used with several piping functions (`%>%`) to create a data frame with `email_ID`, `text`, `class`, and binary valued `spam` column as shown below
