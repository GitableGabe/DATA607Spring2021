...
# path to csv's
csv_Nutrition_A= 
"https://raw.githubusercontent.com/gcampos100/DATA607Spring2021/main/Projects/Project%202/Nutrition%20A.csv"

csv_Nutrition_A_bkp=
  "D:/Docs/CUNY_SPS_Grad/DATA607/Course Docs/Projects/Project 2/Nutrition A.csv"
```
...
```{r}
str_view(df_Nutrition, "-", match = TRUE)
```


```{r}
test<-as.data.frame(gsub("<U+0096>", "", df_Nutrition, fixed=TRUE))
```
