...
```{r}
#m_score <- lm(`Under-5 mortality rate by sex  2018 (male)` ~ `Neonatal deaths as proportion of all under-5 deaths `, data= df_Child_Mortality)
```

```{r}
#par(mar = c(3.5, 4, 1, 0.5), las = 1, mgp = c(2.5, 0.7, 0),
#    cex.lab = 1.5, cex.axis = 1.5)
#plot(`15-24 Year old Male Literacy Rate` ~ `Out of School Rate`, data= df_Child_Mortality,
#     pch = 19, col = COL[1,2],
#     xlab = "Under-5 mortality rate by sex  2018 (male)", ylab = "Neonatal deaths as proportion of all under-5 deaths", axes = FALSE)
#axis(1)
...
```{r}
#df_Child_Mortality$`Neonatal deaths as proportion of all under-5 deaths `
```
